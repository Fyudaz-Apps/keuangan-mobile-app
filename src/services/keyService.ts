...
export const GEMINI_MODEL_OPTIONS = [
  { id: 'gemini-3.1-flash-lite', label: 'Gemini 3.1 Flash Lite', description: 'Cepat & hemat, cukup untuk parsing transaksi' },
  { id: 'gemini-3.5-flash-lite', label: 'Gemini 3.5 Flash Lite', description: 'Terbaru, cepat & hemat' },
  { id: 'gemini-3.5-flash', label: 'Gemini 3.5 Flash', description: 'Akurasi lebih baik, sedikit lebih lambat' },
  { id: 'gemini-flash-latest', label: 'Gemini Flash (latest)', description: 'Alias model Flash terbaru' },
  { id: 'gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro (preview)', description: 'Paling akurat, lebih lambat (kuota terbatas)' },
